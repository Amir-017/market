          ...
          <div className="w-[100%] h-0 lg:h-20 flex flex-col  items-center">
            ...
            <div className="ml-auto w-[95%]  flex gap-1 md:mr-4 ">
              <ul className=" h-10   relatvie w-full gap-x-2  mb-4 p-3  flex flex-row  lg:mb-0 lg:mt-0 justify-start lg:ps-5    ">
                ...
                <div className="  invisible peer-hover:visible peer rounded-xl absolute   peer-hover:bg-gray-50 peer-hover:dark:bg-blue-gray-800 md:left-1 md:top-[29em] left-[1em]  lg:left-[45em]  lg:top-[8rem] ">
        ...
        <div className="w-[80%]  flex flex-col">
          <div className="ml-auto flex gap-1 md:mr-4 w-full justify-start items-start">
            <ul className="ms-0 lg:ms-5 relatvie w-full gap-x-1  mb-4 p-3  flex   lg:mb-0 lg:mt-0 flex-col  ">
              ...
              <div className="hidden w-[60%] md:w-[40%] lg:w-[25%]  peer-hover:block rounded-xl absolute   peer-hover:bg-gray-100 peer-hover:dark:bg-blue-gray-900 left-5  top-[25em]  lg:left-[45em]  lg:top-[9rem] ">
                {aboutAdding && aboutAdding.length == 0 ? (
                  <div className="peer-hover:block w-[40%] flex flex-col justify-center items-center  gap-y-3">
                    <img
                      src={add}
                      alt=""
                      className="w-[100px] h-[100px] rounded-full"
                  ...
                  <div className=" w-full container mx-auto border-[2px]  border-green-900 rounded-2xl">
                    <div className="  flex flex-col justify-center items-center  border-[1px] border-green-700 rounded-2xl font-serif">
