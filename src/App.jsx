    ...
    <div className="bg-white dark:bg-blue-gray-900 ">
      <div className="removeShadwBlack">
        <React.Fragment>
          <Drawer
            open={open}
            className=" p-4 w-[70%] lg:w-full overflow-auto   dark:bg-blue-gray-900 dark:text-white"
          >
            ...
            >
              <Typography
                ...
                to="/beatuy"
                variant="small"
                className="p-1 text-black dark:text-white text-[1.1rem]   rounded-xl  hover:dark:bg-blue-gray-800  hover:bg-gray-300 "
              >
                Beatuy
              </Typography>
              <Typography
                ...
                to="/frag"
                variant="small"
                className="p-1 text-black dark:text-white text-[1.1rem]  hover:rounded-xl hover:dark:bg-blue-gray-800 hover:bg-gray-300"
              >
                Fragrances
              </Typography>
              <Typography
