...
const Fragrances = () => {
  ...
  const getFrag = () => {
    ...
    }).then((data) => setFrag(data.data.products));
  };
  ...
  return (
    <div className="w-full  ">
      {Loading ? (
        <div className="w-full bg-[#EAEAEA] dark:bg-blue-gray-900">
        ...
        <div className="w-full h-[80vh] bg-[#EAEAEA] dark:bg-blue-gray-900 flex justify-center items-center ">
